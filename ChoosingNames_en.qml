        ...
        Rectangle {
            ...
            RowLayout {
                ...
                RowLayout {
                    spacing: 6
                    Text{
                        text: "Row height of selected athletes:"
                    }
                    SpinBox {
                        id: sbHeightSlider
                ...
                RowLayout {
                    spacing: 6
                    Text{
                        text: "Font size of the list of selected athletes:"
                    }
                    SpinBox {
                        id: spinchoise
                ...
                RowLayout {
                    spacing: 6
                    Text{
                        text: "Font size of the list of all athletes:"
                    }
                    SpinBox {
                        id: listAll
